/*
<MODULE_CONTRACT>
<purpose>Load Check Webgogol runner service filesystem paths and polling configuration from environment variables.</purpose>
<non-goals>
...
import { findWorkspaceRoot } from "@gogol/check-core";
...
export function loadRunnerConfig(): RunnerConfig {
  ...
  const checkRoot = process.env.CHECK_WEBGOGOL_ROOT ?? join(workspaceRoot, ".check-webgogol");
  return {
    workspaceRoot,
    checkRoot,
