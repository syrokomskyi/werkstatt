/*
<MODULE_CONTRACT>
<purpose>Filesystem-backed queue and status store for the Check Webgogol runner service workspace.</purpose>
<non-goals>
...
import { parseCheckRunRequest, type CheckRunRequest, type CheckRunStatus } from "@gogol/check-core";
