...
<non-goals>
  <item>Do not define metric specs or label keys — those live in @warpgogol/werkstatt-shared/observability.</item>
...
import { findMetricSpec, type MetricsPusher } from "@warpgogol/werkstatt-shared/observability";
