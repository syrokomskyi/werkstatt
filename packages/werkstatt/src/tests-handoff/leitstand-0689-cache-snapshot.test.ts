...
<MODULE_CONTRACT>
  ...
  <keywords>RFC-0865, leitstand, dev-deploy, certification, gate-decision, test</keywords>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>RFC-0865: update cache-snapshot dev-deploy test to assert --gate-decision requirement.</item>
</CHANGE_SUMMARY>
*/
...
test("leitstand.dev-deploy (cache-snapshot) requires --gate-decision", async () => {
