/*
<MODULE_CONTRACT>
  <purpose>RFC-0851: leitstand.dev-deploy blocked by CERT-TRANSITION-01 during certification transition.</purpose>
  <keywords>RFC-0851, CERT-TRANSITION-01, leitstand, dev-deploy, transition-block, test</keywords>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>RFC-0851: replace legacy dev-deploy tests with transition-block assertion.</item>
</CHANGE_SUMMARY>
*/
...
test("leitstand.dev-deploy blocked by CERT-TRANSITION-01", async () => {
