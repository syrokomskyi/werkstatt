/*
<MODULE_CONTRACT>
  <purpose>RFC-0851: leitstand.dev-deploy evidence-sync tests replaced by CERT-TRANSITION-01 block.</purpose>
  <keywords>RFC-0851, CERT-TRANSITION-01, leitstand, dev-deploy, evidence-sync, transition-block, test</keywords>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>RFC-0851: replace legacy evidence-sync tests with transition-block assertion.</item>
</CHANGE_SUMMARY>
*/
...
test("leitstand.dev-deploy (evidence-sync) blocked by CERT-TRANSITION-01", async () => {
