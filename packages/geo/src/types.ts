...
/** Structurally identical to LocalizedSlug in @gogol/surface. Duplicated to avoid a @gogol/geo -> @gogol/surface dependency (which would form a workspace cycle). */
...
export interface GeoService {
  ...
  providerEntries(
    ...
    defaultLang: string,
    options?: {
      /** Returns an image slug (e.g. "freiburg-skyline") for a neutral slug, or undefined if no image exists. Injected by the consumer to keep @gogol/geo app-agnostic. */
