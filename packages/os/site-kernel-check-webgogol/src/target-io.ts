/*
<MODULE_CONTRACT>
<purpose>Target I/O utilities for check-webgogol: flag parsing, workspace path resolution, and target file reading.</purpose>
<non-goals>
...
import { parseCheckTarget, type CheckTarget } from "@gogol/check-core";
...
): Promise<{ target?: CheckTarget; diagnostics: import("@gogol/site-kernel").Diagnostic[] }> {
