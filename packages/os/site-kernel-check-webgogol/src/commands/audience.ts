/*
<MODULE_CONTRACT>
<purpose>Audience profile validation, audience review run, and audience review validation command handlers for check-webgogol.</purpose>
<non-goals>
...
import { parseAudienceProfile, parseAudienceReview } from "@gogol/check-core";
import type {
  CheckResult,
  KernelCommandInput,
  KernelCommandResult,
    ...
    return diagnosticsResult("check.audience.review.validate", [
      {
        ...
        fixHint: "Pass --review .check-webgogol/runs/<runId>/audience-review.json.",
      },
    ]);
  }
  try {
