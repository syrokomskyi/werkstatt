...
<MODULE_CONTRACT>
<purpose>
  Report, action pack, audience review, and hints artifact builders for check-webgogol OS commands.
  Re-exports makeCheckReport, makeAgentAction, makeAgentActionPack, renderReportHtml from @gogol/check-core.
...
import type { WebgogolCheckHints } from "@gogol/share/check-hints";
