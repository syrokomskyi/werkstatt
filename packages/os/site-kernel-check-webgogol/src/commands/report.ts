/*
<MODULE_CONTRACT>
<purpose>Report generation, action pack generation, and comparison command handlers for check-webgogol.</purpose>
<non-goals>
...
import type { CheckReport } from "@gogol/check-core";
import type {
  CheckResult,
  Diagnostic,
  KernelCommandInput,
