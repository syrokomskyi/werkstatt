...
<MODULE_CONTRACT>
<purpose>
  Re-export barrel for check-webgogol command helpers.
  Diagnostic collectors now live in @gogol/check-core/diagnostics.ts.
...
<CHANGE_SUMMARY>
  ...
  <item>Split into evidence-readers.ts and artifact-builders.ts; diagnostic collectors moved to @gogol/check-core.</item>
</CHANGE_SUMMARY>
*/
