/*
<MODULE_CONTRACT>
<purpose>Target validation, safety validation, and runner info command handlers for check-webgogol.</purpose>
<non-goals>
...
import { getCheckRunnerInfo } from "@gogol/check-runner-node";
import { validateTargetSafety } from "@gogol/check-core";
import type {
  CheckResult,
  KernelCommandInput,
  KernelCommandResult,
