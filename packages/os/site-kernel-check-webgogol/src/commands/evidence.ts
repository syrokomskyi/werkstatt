/*
<MODULE_CONTRACT>
<purpose>Evidence capture, evidence validation, technical/localization/accessibility/content-surface validation, and deterministic run command handlers for check-webgogol.</purpose>
<non-goals>
