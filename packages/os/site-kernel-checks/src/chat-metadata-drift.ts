/*
<MODULE_CONTRACT>
<purpose>Workspace-scoped drift guard for CHAT_ADAPTER_METADATA (@gogol/chat) vs the runtime
...
import { CHAT_ADAPTER_IDS, getChatAdapterMetadata } from "@gogol/chat";
