...
<purpose>
  ...
  app src/content/system.md. This file is the I/O boundary around the pure @gogol/surface
...
import { loadSurfaceModuleContexts, type LoadedModuleContexts } from "@gogol/surface/io";
