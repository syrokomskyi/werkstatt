/*
<MODULE_CONTRACT>
<purpose>Facilitates inventory management and validation for Compass scaffolding across the repository.</purpose>
<non-goals>
...
export async function runCompassInventory(
  ...
  KernelCommandResult<{ entries: number; outputPath: string; summary: CompassInventorySummary }>
> {
...
> {
  ...
  // RFC-0350: Check for Compass TODO sentinels in authored files.
