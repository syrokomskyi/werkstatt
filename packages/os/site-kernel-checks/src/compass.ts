...
now lives in @warpgogol/forge/os/compass/handlers/ (RFC-0556 dependency inversion).
...
export { runCompassInventory, runCompassValidation } from "@warpgogol/forge/os/compass";
