/*
<MODULE_CONTRACT>
<purpose>Check Webgogol URL-first product checks (RFC-0293..0302) plus services workspace and runner rule descriptors.</purpose>
<non-goals>
...
/** Check Webgogol URL-first product checks (RFC-0293..0302) + services + runner. */
export const CHECK_WEBGOGOL_RULES: Record<string, RuleDescriptor> = {
  ...
  "CW-HINT-01": rule(
    "CW-HINT-01",
    "Webgogol check hints are missing or malformed",
    "webgogol.check-hints.validate",
  ),
  "CW-HINT-02": rule(
    "CW-HINT-02",
    "Webgogol check hints contain secret-like data",
    "webgogol.check-hints.validate",
  ),
  "CW-AUD-01": rule(
    "CW-AUD-01",
  ...
  "CW-APP-01": rule(
    "CW-APP-01",
    "Check Webgogol operator app is missing a required scaffold file",
    "check-webgogol.app.validate",
  ),
  "CW-APP-02": rule(
    "CW-APP-02",
    "Check Webgogol operator app home copy is incomplete",
    "check-webgogol.app.validate",
    "warning",
  ),
  "SERVICES-01": rule(
  ...
  "CW-RUNNER-01": rule(
    "CW-RUNNER-01",
    "Check Webgogol runner required file is missing",
    "check-webgogol.runner.validate",
  ),
  "CW-RUNNER-02": rule(
    "CW-RUNNER-02",
    "Check Webgogol runner dependency is missing",
    "check-webgogol.runner.validate",
  ),
  "CW-RUNNER-03": rule(
    "CW-RUNNER-03",
    "Check Webgogol runner imports app code",
    "check-webgogol.runner.validate",
  ),
  "CW-RUNNER-04": rule(
    "CW-RUNNER-04",
    "Check Webgogol runner does not use shared run contracts",
    "check-webgogol.runner.validate",
  ),
  "CW-RUNNER-05": rule(
    "CW-RUNNER-05",
    "Check Webgogol app API imports runner-only code",
    "check-webgogol.runner.validate",
  ),
  "CW-RUN-01": rule(
    "CW-RUN-01",
