/*
<MODULE_CONTRACT>
<purpose>Implements the four Compass audit commands (plan, record, baseline, validate) that drive per-file semantic-truth auditing on a revision cadence (RFC-0352).</purpose>
<non-goals>
