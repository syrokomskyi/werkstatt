...
<CHANGE_SUMMARY>
  <item>RFC-0303: became a thin re-export shim over the canonical @gogol/share/fs fileExists; kept so existing "./lib/file-exists.ts" imports keep working.</item>
</CHANGE_SUMMARY>
*/

export { fileExists } from "@gogol/share/fs";
