/*
<MODULE_CONTRACT>
<purpose>Maintains packages/os/site-kernel-handoff/src/werkstatt/lock.ts as an authored site-kernel-handoff authored module so agents can evolve it without rediscovering local boundaries.</purpose>
<non-goals>
...
export { HEARTBEAT_INTERVAL_MS, DEFAULT_TIMEOUT_SECONDS };
