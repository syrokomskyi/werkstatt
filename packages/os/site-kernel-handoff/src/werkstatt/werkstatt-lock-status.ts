...
in @webgogol/forge/os/werkstatt/handlers/ (RFC-0556 dependency inversion). This file
...
export { runWerkstattLockStatus, type WerkstattLockStatusData } from "@webgogol/forge/os/werkstatt";
