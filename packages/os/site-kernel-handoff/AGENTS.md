...
- The channel model defines `dev` (development), `alt` (staging), and `main` (production) channels in `deployment.channels` (RFC-0627). Each channel has `workerName`, `url`, and optional `secretsFile` (a secret reference, never a raw value).
