/*
<MODULE_CONTRACT>
<purpose>Re-export shim for check-warpgogol command handlers. Split (RFC-0303 Phase 3) into a folder-of-files under commands/ by domain. Individual command handlers live in: commands/target.ts, commands/evidence.ts, commands/report.ts, commands/audience.ts, commands/deploy.ts, commands/services.ts, commands/services-check.ts, commands/hints.ts, commands/app.ts, commands/helpers.ts.</purpose>
<non-goals>
