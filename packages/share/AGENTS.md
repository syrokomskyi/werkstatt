...
| `@warpgogol/share/text-normalize` | `src/text-normalize.ts` | RFC-0235 egress text normalizer |
| `@warpgogol/share/content-reference` | `src/content-reference.ts` | RFC-0527 content reference index resolver — `ContentRefIndex`, `loadContentRefIndex`, `getContentRefIndex`, `resolveReference`, `resolveReferencesInString`, `resolveReferencesDeep`, `EMPTY_CONTENT_REF_INDEX` |
