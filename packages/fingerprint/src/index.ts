...
<non-goals>
  <item>Do not export semantic fingerprint functions — those live in @warpgogol/fingerprint/semantic.</item>
...
<CHANGE_SUMMARY>
  <item>Split public API: root entry point now exports primitives only. Semantic functions moved to @warpgogol/fingerprint/semantic.</item>
</CHANGE_SUMMARY>
*/
