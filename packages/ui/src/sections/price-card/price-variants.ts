/*
<MODULE_CONTRACT>
<purpose>Price variant utilities for currency-aware price display (RFC-0743) — formatPrice, loadDerivedPrices, and buildPriceVariants extracted from price-card-section.astro for testability. RFC-0767: DerivedPriceEntry type and loadDerivedPrices relocated to @warpgogol/share.</purpose>
<non-goals>
...
<CHANGE_SUMMARY>
  ...
  <item>RFC-0767: DerivedPriceEntry type and loadDerivedPrices moved to @warpgogol/share. Now re-imported from @warpgogol/share/semantic and @warpgogol/share/semantic/derived-prices-loader.</item>
</CHANGE_SUMMARY>
*/

import { formatRecurrence } from "@warpgogol/share/formula-eval";
import type { DerivedPriceEntry } from "@warpgogol/share/semantic";
