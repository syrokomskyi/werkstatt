...
import { addDuration } from "@warpgogol/werkstatt-shared/share/knowledge/freshness";
import { parseNdjson, type ClaimEvent } from "@warpgogol/werkstatt-shared/share/knowledge/ledger";
import type {
  CheckResult,
  Diagnostic,
  KernelCommandInput,
