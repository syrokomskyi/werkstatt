...
export const GROWTH_PASSPORT_COMMANDS: CheckCommandEntry[] = [
  /* Wave 0 (RFC-0027): Growth layer */
  {
    ...
    reads: ["<app>/src/content/system.md", "packages/werkstatt-site/src/domain/ontology/growth/**/*.yaml"],
  ...
  },
  {
    ...
    description:
      "Validate funnel YAML files in packages/werkstatt-site/src/domain/ontology/growth/funnels/ and cross-reference with system.yaml growth.funnels[] (DNA-28, RFC-0027).",
    scope: "app",
    flags: {},
    supportsAllSites: true,
    reads: ["<app>/src/content/system.md", "packages/werkstatt-site/src/domain/ontology/growth/funnels/**/*.yaml"],
  ...
  },
  {
    ...
    description:
      "Validate experiment YAML files in packages/werkstatt-site/src/domain/ontology/growth/experiments/ and cross-reference with system.yaml growth.experiments[] (DNA-29, RFC-0027).",
    scope: "app",
    flags: {},
    supportsAllSites: true,
    reads: ["<app>/src/content/system.md", "packages/werkstatt-site/src/domain/ontology/growth/experiments/**/*.yaml"],
