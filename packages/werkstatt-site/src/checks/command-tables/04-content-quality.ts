...
export const CONTENT_QUALITY_COMMANDS: CheckCommandEntry[] = [
  ...
  /* RFC-0264 */
  {
    ...
    description:
      "Guard the @warpgogol/werkstatt-shared/share barrel split: BARREL-01 fails when a package's root src/index.ts exceeds the export-line threshold (error for @warpgogol/werkstatt-shared/share, warning elsewhere); BARREL-02 fails when a symbol is exported from both the root barrel and a declared subpath (RFC-0264).",
    scope: "workspace",
    supportsAllSites: true,
    flags: {},
  ...
  /* RFC-0303 */
  {
    name: "fs.walk.lint",
    description:
      "WALK-01: fails when a packages/** source file declares its own nested recursive readdir walker instead of importing collectFiles from @warpgogol/werkstatt-shared/share/fs (RFC-0303).",
    scope: "workspace",
    supportsAllSites: true,
    flags: {},
    reads: ["packages/*/src/**/*.ts", "packages/*/src/**/*.tsx"],
  ...
  /* RFC-0230 */
  {
    ...
    description:
      "Scan registered @warpgogol/werkstatt-shared/share UI-facing helper targets for unclassified hardcoded public strings (RFC-0230).",
    scope: "workspace",
    flags: {
      path: {
        kind: "string",
