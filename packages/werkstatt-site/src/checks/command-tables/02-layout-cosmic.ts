...
export const LAYOUT_COSMIC_COMMANDS: CheckCommandEntry[] = [
  ...
  },
  {
    ...
    description:
      "Fail when any Star/Planet/Moon cosmic-catalog name appears as a string literal in packages/share/src — cosmic-name-keyed dispatch behavior must derive from @warpgogol/werkstatt-shared/ontology/archetypes instead (RFC-0263).",
    scope: "workspace",
    supportsAllSites: true,
    flags: {},
