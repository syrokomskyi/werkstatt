...
export const STRUCTURE_NAMING_COMMANDS: CheckCommandEntry[] = [
  ...
  /* RFC-0037 */
  {
    ...
    description:
      "Validate that apps use @warpgogol/werkstatt-shared/share utilities instead of re-implementing them locally. Per RFC-0037: allows astro:content imports in @warpgogol/werkstatt-shared/share.",
    scope: "workspace",
    flags: {
