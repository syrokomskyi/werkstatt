...
export const PAGE_RUNTIME_COMMANDS: CheckCommandEntry[] = [
  ...
  },
  {
    ...
    description:
      "Verify buildPage(entry, ctx) from @warpgogol/werkstatt-shared/share returns a valid ResolvedPage shape and that visibility filtering works correctly (DNA-25, RFC-0026).",
    scope: "workspace",
    flags: {},
    supportsAllSites: true,
