...
import { surfaceAncestorPageIds } from "@warpgogol/werkstatt-shared/share/semantic";
...
function validateSurfaceHierarchy(entries: VirtualRouteEntry[], defaultLang: string): string[] {
  ...
  for (const entry of entries) {
    ...
    // RFC-0229: the surface hierarchy shape is owned by @warpgogol/werkstatt-shared/share so the validator and the
