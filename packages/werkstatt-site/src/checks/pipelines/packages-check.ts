...
export const PACKAGES_CHECK_PIPELINE: KernelPipelineStep[] = [
  ...
  // RFC-0230: hardcoded strings in UI-facing @warpgogol/werkstatt-shared/share helpers
  ...
  // Cross-reference nachweis component required props against resolver assignments.
  { command: "nachweis.props.coverage.lint" },
