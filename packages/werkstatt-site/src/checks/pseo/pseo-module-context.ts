...
<purpose>
  ...
  app src/content/system.md. This file is the I/O boundary around the pure @warpgogol/werkstatt-shared/surface
...
import { loadSurfaceModuleContexts, type LoadedModuleContexts } from "@warpgogol/werkstatt-shared/surface/io";
