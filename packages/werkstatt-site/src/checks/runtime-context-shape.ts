...
<MODULE_CONTRACT>
<purpose>
runtime.context.shape — validates that RuntimeContext in @warpgogol/werkstatt-shared/share has
...
import { EMPTY_RUNTIME_CONTEXT, type RuntimeContext } from "@warpgogol/werkstatt-shared/share/runtime-context";
