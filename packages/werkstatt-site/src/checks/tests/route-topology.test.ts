...
const INDEX_ASTRO = `---
import { resolvePageRoute } from "@warpgogol/werkstatt-shared/share/route";
---
<resolvePageRoute />
`;

const SLUG_ASTRO = `---
import { getStaticPathsForDefaultLang } from "@warpgogol/werkstatt-shared/share/route";
---
<getStaticPathsForDefaultLang />
`;

const PREFIXED_ASTRO = `---
import { getStaticPathsForPrefixedLangs, getStaticPathsForDefaultLangRedirects } from "@warpgogol/werkstatt-shared/share/route";
---
