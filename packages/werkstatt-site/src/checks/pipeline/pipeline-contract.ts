...
<MODULE_CONTRACT>
<purpose>
page.pipeline.contract — validates that buildPage(entry, ctx) from @warpgogol/werkstatt-shared/share
...
import { buildPage, type ResolvedPage, type PageEntry } from "@warpgogol/werkstatt-shared/share/page";
import { EMPTY_RUNTIME_CONTEXT } from "@warpgogol/werkstatt-shared/share/runtime-context";
...
export async function runPagePipelineContract(
  ...
  if (typeof buildPage !== "function") {
    violations.push("@warpgogol/werkstatt-shared/share does not export buildPage as a function");
  }
  if (typeof EMPTY_RUNTIME_CONTEXT !== "function") {
    violations.push("@warpgogol/werkstatt-shared/share does not export EMPTY_RUNTIME_CONTEXT as a function");
  }
