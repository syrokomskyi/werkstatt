...
<non-goals>
  <item>Do not redefine the effects contract or the target×kind matrix — @warpgogol/werkstatt-shared/share owns it.</item>
  <item>Do not replace effectAssignmentSchema.superRefine in content.validate; this complements it.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>RFC-0156: introduce effects.contract.validate + effects.coverage.audit reusing the @warpgogol/werkstatt-shared/share effect schema.</item>
</CHANGE_SUMMARY>
*/
...
import { effectAssignmentSchema } from "@warpgogol/werkstatt-shared/share/schemas/effects";
import type {
  KernelCommandInput,
  KernelCommandResult,
