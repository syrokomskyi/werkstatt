...
<notes>
  <item>RFC-0138: references in block props are substituted at render time by the shared
        page handler (@warpgogol/werkstatt-site/share astro/page-handler). A reference that passes this
...
import type { ContentRefIndex, SourceRef } from "@warpgogol/werkstatt-site/share/content-reference";
import { resolveReference } from "@warpgogol/werkstatt-site/share/content-reference";
import { scanFormulas, resolveFormula } from "@warpgogol/werkstatt-site/share/formula-eval";
