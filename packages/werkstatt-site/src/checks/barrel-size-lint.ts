...
<MODULE_CONTRACT>
<purpose>
barrel.size.lint — RFC-0264: guards the end state of the @warpgogol/werkstatt-shared/share barrel
split. BARREL-01 fails (error for @warpgogol/werkstatt-shared/share, warning for every other
...
const ERROR_PACKAGE = "@warpgogol/werkstatt-shared/share";
...
const COMPLETED_WAVE_SUBPATHS: Record<string, string[]> = {
  "@warpgogol/werkstatt-shared/share": ["src/page.ts", "src/i18n/localization.ts"],
};
