...
<CHANGE_SUMMARY>
  ...
  <item>Consolidated: delegates to @warpgogol/werkstatt-shared/ontology projectBiomeToTokens — single source of truth.</item>
</CHANGE_SUMMARY>
*/

import { projectBiomeToTokens } from "@warpgogol/werkstatt-shared/ontology";
