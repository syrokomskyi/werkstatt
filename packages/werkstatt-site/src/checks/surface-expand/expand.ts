...
export async function expandBlueprint(
  ...
  // RFC-0238: geo provider axes are resolved from @warpgogol/werkstatt-site/geo instead of content collections.
  ...
  // RFC-0238: geo provider axes use @warpgogol/werkstatt-site/geo's locale-aware slugByLang.
