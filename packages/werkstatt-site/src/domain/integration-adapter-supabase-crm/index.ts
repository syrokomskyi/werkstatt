/*
<MODULE_CONTRACT>
<purpose>@warpgogol/werkstatt-site/integration-adapter-supabase-crm public entry point. Exports the DestinationAdapter
(supabaseBufferDestinationAdapter), the required secret names, and the Supabase client factory.
Re-exports CrmBuffer types from @warpgogol/werkstatt-site/integration/crm-buffer for convenience.</purpose>
<non-goals>
