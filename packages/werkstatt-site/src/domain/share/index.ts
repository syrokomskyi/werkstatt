...
<MODULE_CONTRACT>
<purpose>
Deprecated compatibility barrel for @warpgogol/werkstatt-site/share (RFC-0264). New code MUST
...
`@warpgogol/werkstatt-site/share/page` / `@warpgogol/werkstatt-site/share/i18n`.
</purpose>
<non-goals>
...
/** @deprecated import from "@warpgogol/werkstatt-site/share/content" instead */
export * from "./content/index.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/semantic" instead */
...
/** @deprecated import from "@warpgogol/werkstatt-site/share/middleware" instead */
export * from "./middleware/language-redirect.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/entitlement" instead */
export * from "./entitlement.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/offer-capacity" instead */
export * from "./offer-capacity.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/knowledge" instead */
export * from "./knowledge/index.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/schemas" instead */
export * from "./schemas/index.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/feature-policy" instead */
export * from "./feature-policy.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/counter-utils" instead */
...
/** @deprecated import from "@warpgogol/werkstatt-site/share/image-provider" instead */
export * from "./image-provider.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/runtime-context" instead */
export { EMPTY_RUNTIME_CONTEXT } from "./runtime-context.ts";
export type { RuntimeContext } from "./runtime-context.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/visibility" instead */
export * from "./visibility.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/wrap-inline-numbers" instead */
export * from "./wrap-inline-numbers.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/text-normalize" instead */
export * from "./text-normalize.ts";
// dev-props-validator is NOT re-exported from the root barrel. It imports
// node:fs/promises and @warpgogol/werkstatt-site/ontology/schemas (which also imports node:fs),
...
// Import from "@warpgogol/werkstatt-site/share/dev-props-validator" subpath directly if needed.
/** @deprecated import from "@warpgogol/werkstatt-site/share/rfc0042-utils" instead */
export { need, cast, withDefault } from "./rfc0042-utils.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/shared-context" instead */
export * from "./shared-context.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/content-discipline" instead */
export * from "./content-discipline/types.ts";
export * from "./content-discipline/parsers.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/legal" instead */
...
/** @deprecated import from "@warpgogol/werkstatt-site/share/material-credits" instead */
export {
...
/** @deprecated import from "@warpgogol/werkstatt-site/share/attribution-display" instead */
export * from "./attribution-display.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/string-utils" instead */
export { toKebabCase } from "./string-utils.ts";
/** @deprecated import from "@warpgogol/werkstatt-site/share/css-value-normalize" instead */
