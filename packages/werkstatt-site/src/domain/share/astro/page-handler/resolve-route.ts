...
<non-goals>
  <item>Do not import from @warpgogol/werkstatt-site/pbp — semantic model is injected via optional callback.</item>
...
export async function resolvePageRoute(options: ResolvePageRouteOptions): Promise<PageRouteData> {
  ...
  // Optional semantic model building via callback — avoids circular dep on @warpgogol/werkstatt-site/pbp
