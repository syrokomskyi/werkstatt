...
@warpgogol/werkstatt-site/passport; this module owns only the canonical payload format and
...
<non-goals>
  <item>Do not import or call Ed25519 signing/verification primitives — that
        is @warpgogol/werkstatt-site/passport's job. This module is pure and dependency-free.</item>
