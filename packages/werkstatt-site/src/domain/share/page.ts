...
<CHANGE_SUMMARY>
  ...
  <item>RFC-0091: PLANET_IMPORT_PATHS and BLOCK_TYPE_TO_COSMIC_NAME now derived from registry; import from @warpgogol/werkstatt-site/ontology/archetypes instead of literal constants.</item>
  ...
  <item>RFC-0264: relocated SectionProps/SectionPageOverride here from the @warpgogol/werkstatt-site/share root barrel (its natural domain owner); consumers now import from @warpgogol/werkstatt-site/share/page.</item>
</CHANGE_SUMMARY>
*/
...
} from "@warpgogol/werkstatt-site/ontology/archetypes";

// @ai-invariant: PageEntry and BlockEntry shapes MUST stay structurally
// compatible with @warpgogol/werkstatt-site/ontology/schemas PageEntrySchema / BlockEntrySchema.
...
// props extend this shape. RFC-0264: relocated from the @warpgogol/werkstatt-site/share root
...
// Derived from the archetype registry via @warpgogol/werkstatt-site/ontology/archetypes
...
// `packages/ontology/archetypes/index.yaml` is regenerated by
// `archetype.registry.build` from every shell.* manifest under
// `packages/ui/src/components/shell/`. The previous
