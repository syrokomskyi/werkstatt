...
<CHANGE_SUMMARY>
  <item>RFC-0033: Moved from app content schemas/features to @warpgogol/werkstatt-site/share. Import switched from "astro/zod" to "zod" for framework neutrality.</item>
 ...
 * from @warpgogol/werkstatt-site/ontology (DNA-17, RFC-0023), which identifies each section
