...
// RFC-0470: buildPageSemanticModel is local to @warpgogol/werkstatt-site/pbp.
// Sites import it from @warpgogol/werkstatt-site/pbp/semantic-profile.
...
export async function loadTargetCurrencies(
