...
<non-goals>
  ...
  <item>Does not define JSON-LD or semantic model logic — that lives in @warpgogol/werkstatt-shared/share.</item>
...
import type { SemanticFaqEntry } from "@warpgogol/werkstatt-shared/share/semantic";
