...
/**
 * RFC-0192: a block in a baked page. Structurally compatible with `@warpgogol/werkstatt-site/share` `BlockEntry`, but
 * declared here so `@warpgogol/werkstatt-site/surface` stays the lower-level package with no dependency on share
...
/** RFC-0192: a baked block-declarative page. Structurally compatible with `@warpgogol/werkstatt-site/share` `PageEntry`. */
