...
<MODULE_CONTRACT>
<purpose>
Master barrel for @warpgogol/werkstatt-site/ontology — re-exports all public APIs from the
...
// node:fs/promises. Import from @warpgogol/werkstatt-site/ontology/schemas/manifest-resolver.
