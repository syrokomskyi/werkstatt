...
<MODULE_CONTRACT>
<purpose>
Barrel export for @warpgogol/werkstatt-site/ontology/schemas sub-path.
...
<CHANGE_SUMMARY>
  ...
  <item>Architecture review 2026-07-10: extracted platform operations schemas to @warpgogol/werkstatt-site/ontology/operations; re-export getSectionPropsSchema from manifest-resolver.ts.</item>
</CHANGE_SUMMARY>
*/
...
// @warpgogol/werkstatt-site/ontology/schemas/manifest-resolver directly.
...
// naming-policy) have been extracted to @warpgogol/werkstatt-site/ontology/operations.
