...
<non-goals>
  <item>Do not implement the buildPage pipeline here — that lives in @warpgogol/werkstatt-site/share/page.</item>
...
// ---------------------------------------------------------------------------
// VisibilityExprSchema (re-declared here to avoid cross-package dep on @warpgogol/werkstatt-site/share)
// page.block.validate uses the canonical one from @warpgogol/werkstatt-site/share;
