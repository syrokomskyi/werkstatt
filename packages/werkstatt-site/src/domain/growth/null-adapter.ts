...
<CHANGE_SUMMARY>
  <item>Inlined from the former @warpgogol/werkstatt-site/growth-adapter-null package (architecture review 2026-07-10). The null adapter is a built-in, not a vendor integration — it earns no separate package seam.</item>
</CHANGE_SUMMARY>
*/

/**
 * @warpgogol/werkstatt-site/growth — built-in NullAdapter
 *
