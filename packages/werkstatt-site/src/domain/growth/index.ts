...
/**
 * @warpgogol/werkstatt-site/growth — server-side re-exports
 *
 * This is the server/build-time surface of the growth package.
 * Import from specific sub-paths on the client:
 *   - "@warpgogol/werkstatt-site/growth/emit"    for emit()
 *   - "@warpgogol/werkstatt-site/growth/client"  for bootGrowthLayer()
 *   - "@warpgogol/werkstatt-site/growth/adapter" for GrowthAdapter / EmittedEvent types
 *   - "@warpgogol/werkstatt-site/growth/config"  for GrowthConfig types + schema
 *   - "@warpgogol/werkstatt-site/growth/provider" for the <GrowthProvider> Astro island
 *
 * RFC-0027 / DNA-27..30
 */

// Adapter types — used by adapter package authors and build-time validators.
// EVENT_NAMES and KNOWN_ADAPTER_IDS live at @warpgogol/werkstatt-site/growth/adapter only.
export type {
  GrowthAdapter,
  GrowthAdapterConfig,
  EmittedEvent,
...
// Built-in NullAdapter — inlined from former @warpgogol/werkstatt-site/growth-adapter-null package
