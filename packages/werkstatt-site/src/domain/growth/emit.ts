...
/**
 * @warpgogol/werkstatt-site/growth — emit() singleton + createEmitQueue() factory
 *
 ...
 *   import { emit } from "@warpgogol/werkstatt-site/growth/emit";
 ...
 * that cannot import @warpgogol/werkstatt-site/growth/emit directly (e.g. Astro inline scripts
 * with define:vars).
 */
