...
import { biomeSchema, systemManifestSchema } from "@warpgogol/werkstatt-shared/ontology/schemas";
import {
  BIOME_TO_TOKEN_MAP,
  BIOME_TOKEN_ALIASES,
  BIOME_TOKEN_DERIVED,
...
import { normalizeCssValue } from "@warpgogol/werkstatt-shared/share/css-value-normalize";
...
// BIOME_TO_TOKEN_MAP is imported from @warpgogol/werkstatt-shared/ontology (consolidated projection).
...
export async function runBiomeCssGenerate(
  ...
  const cssLines: string[] = [
    "/* " + GENERATED_MARKER + " */",
    "/* Source: packages/werkstatt-site/src/domain/ontology/biomes/" + biomeId + ".yaml              */",
  ...
  // then derived entries — all from @warpgogol/werkstatt-shared/ontology.
