...
import { scanFormulas } from "@warpgogol/werkstatt-shared/share/formula-eval";
import { loadContentRefIndex } from "@warpgogol/werkstatt-shared/share/content-reference";
import type {
  KernelCommandInput,
  KernelCommandResult,
...
// Field path uses the fixed pattern from @warpgogol/werkstatt-shared/share (no trailing dots)
