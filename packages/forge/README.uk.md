...
Створіть нову папку, відкрийте її у вашому ШІ-IDE (Windsurf, Cursor або будь-якому IDE з підтримкою ШІ-агентів) і вставте це:

```
Install https://npmjs.com/package/@warpgogol/forge in this folder and set up my project. I want to build: [опишіть ваш проєкт]
```
