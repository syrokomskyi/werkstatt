...
- **accepted/draft → implemented + backfilled implementedAt (verified-live):** 0009, 0012, 0024 (draft), 0032 (draft), 0050, 0051, 0052, 0096, 0134, 0135, 0136, 0144–0148, 0149, 0150, 0151, 0152. Evidence: signature artifacts present (e.g. `@gogol/share/semantic`, `business-projection.ts`, `responsive-image.astro`, `preview.images.generate` registered, `src/pages/api/send-message.ts` + adapter, effects `registry.ts`).
