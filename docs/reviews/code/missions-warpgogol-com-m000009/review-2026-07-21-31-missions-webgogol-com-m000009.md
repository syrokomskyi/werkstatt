...
- **Pass — DNA-4 (canonical content).** The ref/id mismatch is fixed: `contactPointRefs.default.ref` in both `de/business.md:22` and `uk/business.md:22` now points to `https://warpgogol.com/id/contact/general-email`, matching the entity id at `de/contact/general-email.md:3`.
