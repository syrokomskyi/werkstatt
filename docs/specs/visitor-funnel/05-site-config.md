...
```sh
rtk pnpm exec werkstatt run funnel.contract.validate  --site webgogol-com --json
rtk pnpm exec werkstatt run funnel.stage.validate     --site webgogol-com --json
rtk pnpm exec werkstatt run funnel.copy.validate      --site webgogol-com --json
rtk pnpm exec werkstatt run funnel.lagebild.validate  --site webgogol-com --json
rtk pnpm exec werkstatt run integration.config.validate --site webgogol-com --json
rtk pnpm exec werkstatt run integration.secrets.validate --site webgogol-com --json
rtk pnpm exec werkstatt run consent.activation.validate  --site webgogol-com --json   # click-to-load guarantee
rtk pnpm exec werkstatt run legal.processors.validate    --site webgogol-com --json   # UChat/Stripe named in privacy policy
```
