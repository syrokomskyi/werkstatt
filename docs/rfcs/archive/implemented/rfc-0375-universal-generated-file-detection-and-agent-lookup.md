...
acceptance:
  ...
  - probe: run
    command: "site-kernel run generated.file.lookup --path apps/warpgogol-com/public/robots.txt --json"
    expect:
      exitCode: 0
  - probe: file-contains
...
```json
{
  ...
  "path": "apps/warpgogol-com/public/_img/portrait/320.webp",
  "generated": true,
  "category": "B",
  "markerPolicy": "registry-only",
...
{
  "command": "generated.file.lookup",
  "path": "apps/warpgogol-com/src/content/pages/de/home.md",
  "generated": false
}
```
...
```json
{
  ...
  "files": [
    {
      "path": "apps/warpgogol-com/public/robots.txt",
      "generated": true,
      "category": "B",
...
| `warpgogol.check.hints.generate` | `public/.well-known/warpgogol-check.json` | N/A (JSON, field-based) | No change needed (same as above) |
