...
- [x] `isitagentready.com` reports llms.txt references all agent discovery endpoints for warpgogol.com after deploy (evidence: live `https://warpgogol.com/llms.txt` serves all 4 agent links — `agent.json`, `api-catalog`, `mcp/server-card.json`, `agent.openapi.json`; release `warpgogol-com-r000017` promoted to main 2026-08-10)
