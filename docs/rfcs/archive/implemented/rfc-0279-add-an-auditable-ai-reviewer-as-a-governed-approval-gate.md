...
pnpm exec site-kernel run surface.review.run --app webgogol-com --module pseo --queue ready --json

# Recompute agreement/defect metrics against the human-labelled golden set.
pnpm exec site-kernel run surface.review.calibrate --app webgogol-com --module pseo --json

# Validate reviewer configuration and log integrity.
pnpm exec site-kernel run surface.review.validate --app webgogol-com --json
```
