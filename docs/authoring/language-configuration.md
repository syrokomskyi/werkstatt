...
```bash
pnpm exec site-kernel run i18n.config.validate --site <your-app>
```
...
```bash
pnpm exec site-kernel run i18n.detect.implement --site <your-app>
```
...
```bash
rm -rf src/content/pages/en
rm -rf src/content/components/en
```
