...
Each extraction repo has a `.github/workflows/ci.yml` that runs on push to `main` and publishes to npm automatically. The CI workflow MUST be configured as follows:
