...
6. Commit knowledge file updates: `git add packages/wgogol-skills/skills/wg-onboard/learned-principles.md packages/wgogol-skills/skills/wg-onboard/qa-log.md && git commit -m "chore: update wg-onboard knowledge from run"`.
