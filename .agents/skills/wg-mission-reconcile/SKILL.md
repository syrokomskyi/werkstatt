...
- `systemId` — the Sternsystem ID (e.g. `webgogol-com`)
- `state` — must be `open`
...
6. Commit knowledge file updates: `git add packages/wgogol-skills/skills/wg-mission-reconcile/learned-principles.md packages/wgogol-skills/skills/wg-mission-reconcile/qa-log.md && git commit -m "chore: update wg-mission-reconcile knowledge from run"`.
