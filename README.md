...
- [CHANGELOG.md](CHANGELOG.md) — internal changelog (all notable changes)
- [CHANGELOG_PUBLIC.md](CHANGELOG_PUBLIC.md) — public client-facing changelog

Both are generated by [`@warpgogol/changelog-live`](https://www.npmjs.com/package/@warpgogol/changelog-live) from git history. Configuration lives in [`changelog.config.yaml`](changelog.config.yaml).
